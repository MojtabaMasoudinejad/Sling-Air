...
const Header = ({ handleChange, reservationId }) => {
  ...
  useEffect(() => {
    // TODO: GET all flight numbers is DONE
      ...
      <Container>
        ...
        <label>
          ...
          <Select onChange={handleChange}>
            ...
            {/* TODO: option for each flight number is DONE */}
          </Select>
        </label>
      </Container>
      <Nav>
        <>
          {/* TODO: only show link if the user has a reservation already is ALMOST DONE */}
          {reservationId ? (
